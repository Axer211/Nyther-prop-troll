...
-- BUTTON HOVER EFFECT
local function addButtonHover(button, originalColor)
    button.MouseEnter:Connect(function()
        TweenService:Create(button, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(originalColor.R * 255 * 1.2, originalColor.G * 255 * 1.2, originalColor.B * 255 * 1.2)}):Play()
    end)
...
addButtonHover(StartBtn, StartBtn.BackgroundColor3)
addButtonHover(StopBtn, StopBtn.BackgroundColor3)
addButtonHover(RGBBtn, RGBBtn.BackgroundColor3)
addButtonHover(SpeedBtn, SpeedBtn.BackgroundColor3)
...
StartBtn.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(StartBtn, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0,150,80)}):Play()
    ...
    task.spawn(function()
        ...
        -- Reset button when trolling stops
        StartBtn.Text = "▶ START"
        TweenService:Create(StartBtn, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0,180,100)}):Play()
    end)
end)
...
RGBBtn.MouseButton1Click:Connect(function()
    ...
    -- Visual feedback for RGB button
    if rgbProps then
        TweenService:Create(RGBBtn, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(100,50,200)}):Play()
    else
        TweenService:Create(RGBBtn, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0,120,255)}):Play()
    end
...
SpeedBtn.MouseButton1Click:Connect(function()
    ...
    -- Visual feedback for speed button
    TweenService:Create(SpeedBtn, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(255,180,50)}):Play()
    task.wait(0.15)
    TweenService:Create(SpeedBtn, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(255,140,0)}):Play()
...
StopBtn.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(StopBtn, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(180,0,30)}):Play()
    task.wait(0.2)
    TweenService:Create(StopBtn, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(200,0,50)}):Play()
